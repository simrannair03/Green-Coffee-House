    ...
    if (isset($_GET['get_id'])) {
        ...
        if ($get_product->rowCount()>0) {
            while($fetch_p = $get_product->fetch(PDO::FETCH_ASSOC)){
                ...
                $insert_order->execute([unique_id(),$user_id,$name,$number,$email,$address,$address_type,$method,$fetch_p,$fetch_p['price'],1,$status]);
        ...
        while ($f_cart=$verify_cart->fetch(PDO::FETCH_ASSOC)) {
            ...
            $fetch_p= $select_products->fetch(PDO::FETCH_ASSOC);
        ...
        <div class="main">
            ...
            <section class="checkout">
                <div class="title">
                    ...
                    <h1>checkout summary</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam, saepe.</p>
                </div>
                    <div class="row">
                        <form method="post">
                            ...
                            <div class="flex">
                                ...
                                <div class="box">
                                    <div class="input-field">
                                            <p> address_line 01 <span>*</span></p>
                                            <input type="text" name="flat" required maxlength="50" placeholder="eg. flat & building number" class="input">
                                    </div>
                                    <div class="input-field">
                                            <p> address_line 02 <span>*</span></p>
                                            <input type="text" name="street" required maxlength="50" placeholder="eg. street name" class="input">
                                    </div>
                                    <div class="input-field">
                                    ...
                                    <div class="input-field">
                                            ...
                                            <input type="text" name="pincode" required maxlength="6" placeholder="11022" min="0" max="999999" class="input">
                                    </div>
                                </div>    
                            </div>
                        ...
                        <div class="summary">
                            ...
                            <div class="box-container">
                                ...
                                <div class="flex">
                                    ...
                                    <div>
                                        <h3 class="name"><?=$fetch_get['image'];?></h3>
